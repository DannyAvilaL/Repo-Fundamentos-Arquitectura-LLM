...
Esta guía permite a cualquier estudiante correr **todo el PoC de la Sesión 5 sin gastar un centavo ni tener ninguna API key**, usando un modelo local con [Ollama](https://ollama.com/).
...
Si responde, el servidor local está funcionando y el backend de la Sesión 5 podrá usarlo automáticamente.

## 5. Conectarlo al backend de la Sesión 5
